...
SEED_ITEMS: list[tuple[str, str, list[str]]] = [
    ...
    ("Punta Gorda Nursery",           "plants",      ["Beautyberry", "Coontie", "Firebush", "Gopher Apple", "Muhly Grass", "Saw Palmetto", "Simpson Stopper", "Wild Coffee"]),
    ("Punta Gorda Nursery",           "fruit_trees", ["Avocado tree", "Banana", "Fig tree", "Guava", "Mango tree", "Moringa"]),
    ("Green Thumb Nursery — Venice",  "plants",      ["Coontie", "Firebush", "Muhly Grass", "Sabal Palm", "Wax Myrtle"]),
    ("Green Thumb Nursery — Venice",  "fruit_trees", ["Citrus tree", "Fig tree", "Loquat tree", "Persimmon tree"]),
    ...
    ("Tropicana Nursery",             "plants",      ["Areca Palm", "Bismarck Palm", "Bougainvillea", "Plumbago", "Wax Myrtle"]),
    ("Tropicana Nursery",             "fruit_trees", ["Avocado tree", "Banana", "Carambola", "Mango tree", "Papaya"]),
    ("Tropical Nursery of SW Florida","fruit_trees", ["Avocado tree", "Banana", "Black Sapote", "Canistel", "Jackfruit", "Mango tree", "Moringa", "Rollinia", "Sugar Apple"]),
    ("Tropical Nursery of SW Florida","plants",      ["Barbados Cherry", "Noni", "Pigeon Pea", "Roselle"]),
    ...
    ("Ace Hardware & Feed — Osprey",  "livestock",   ["chicken feed", "chick starter feed", "layer pellets", "rabbit feed"]),
    ("Ace Hardware & Feed — Osprey",  "seeds",       ["bahia grass seed", "pasture mix", "wildflower mix"]),
